...
CREATE TABLE public.meet_result(
  ...
  AgeClassFrom float NOT NULL,
  AgeClassTo float NOT NULL,
  BirthYearClassFrom float NOT NULL,
  BirthYearClassTo float NOT NULL,
  WeightClassFrom float NOT NULL,
  WeightClassTo float NOT NULL,
